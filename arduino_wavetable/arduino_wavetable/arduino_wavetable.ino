...
//how does writing a 3 make it 11???
...
void loop()
{
  ...
  while (!sampleFlag) { // if sampleFlag = 0
  ...
  //Serial.println(sramBufferSampleValue); //använd tillsammans med serial plotter för att se vågformen.
